 ...
 
{
	...
	$rs=mysqli_query($koneksi,"Insert into user_admin (`nama_admin`,`username`,`password`) values ('".$_POST['nama_admin']."','".$_POST['username']."','".md5($_POST['password'])."')") or die(mysqli_error());
	if($rs)
	{
