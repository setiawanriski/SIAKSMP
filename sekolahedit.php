...
{
	$rs=mysqli_query($koneksi,"Select * from sekolah where sha1(nama)='".$_GET['id_sekolah']."'");
...
if(isset($_GET['edit']))
{
	...
	$rs=mysqli_query($koneksi,"Update sekolah SET nama='".$_POST['nama']."',nss='".$_POST['nss']."',nis='".$_POST['nis']."',ntsn='".$_POST['ntsn']."',skpd='".$_POST['skpd']."',alamat='".$_POST['alamat']."',nomor='".$_POST['nomor']."',fax='".$_POST['fax']."',email='".$_POST['email']."',profile='".$_POST['profile']."',tahun='".$_POST['tahun']."',semester='".$_POST['semester']."' Where sha1(nama)='".$_GET['id_sekolah']."'");
	if($rs)
	{
		echo "<script>window.location='?page=sekolahtampil'</script>";
	}
