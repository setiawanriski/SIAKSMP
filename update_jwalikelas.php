...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"update tbl_jwalikelas set nama_kelas='$nama_kelas',jurusan='$jurusan',id_guru='$id_guru', nip='$nip' where id_jwalikelas='$id_jwalikelas'");
...
<!-- end page-heading -->
			<?php
			$jwalikelas=mysqli_fetch_array(mysqli_query($koneksi,"select * from tbl_jwalikelas where id_jwalikelas='$_GET[id_jwalikelas]'"));
