...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into data_siswa values('','$nama_siswa','$nis','$kelamin','$alamat_siswa','$telpon_siswa','$username','$password')");
...
<tr>
    ...
    <div id="content-table-inner">
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from data_siswa order by nama_siswa asc");
