...
<tr>
    ...
    <div id="content-table-inner">
		...
		$siswa=mysqli_fetch_array(mysqli_query($koneksi,"select nama_siswa, nis, kelas from data_siswa where id_siswa= '$id_siswa'"));
      ...
      <br />
       ...
       <tr bgcolor="#99CC33">
        ...
        <?php
		$view=mysqli_query($koneksi,"SELECT * FROM tbl_nilai nilai, tbl_jadwal jadwal WHERE nilai.id_siswa='$id_siswa' and nilai.id_jadwal=jadwal.id_jadwal order by jadwal.nama_pelajaran asc");
