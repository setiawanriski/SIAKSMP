...
$sql =mysqli_query($koneksi,"SELECT b.nama_pelajaran,b.kkm,c.nmjur,c.nmketua,d.nama,f.nmkelas,a.* from tbl_jadwal b,jurusan c,mahasiswa d,kelas f,krs a WHERE b.id_jadwal=a.id_jadwal AND c.kdjur=a.kdjur AND d.nim=a.nim AND f.kdkelas = a.kdkelas AND a.nim='$_POST[nim]' ORDER BY a.kdmatkul");
