...
<tr>
    ...
    <div id="content-table-inner">
		...
		$kelass=mysqli_fetch_array(mysqli_query($koneksi,"select * from tbl_jadwal where kelas='$kelas'"));
      ...
      <br />
		...
		$view=mysqli_query($koneksi,"SELECT * FROM data_siswa WHERE kelas='$kelas' order by nama_siswa asc");
